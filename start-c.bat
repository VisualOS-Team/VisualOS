...
dd if=kernel.bin of=boot.img bs=512 seek=10 conv=notrunc
...
wsl qemu-system-x86_64 -drive format=raw,file=boot.img -d int,cpu_reset,guest_errors,pcall,trace:all > log.txt 2>&1
